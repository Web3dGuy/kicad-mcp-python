...
class Pad(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: common.types.base_types_pb2.KIID | None=..., locked: common.types.base_types_pb2.LockedState.ValueType=..., number: builtins.str=..., net: global___Net | None=..., type: global___PadType.ValueType=..., pad_stack: global___PadStack | None=..., position: common.types.base_types_pb2.Vector2 | None=..., copper_clearance_override: common.types.base_types_pb2.Distance | None=..., pad_to_die_length: common.types.base_types_pb2.Distance | None=..., pad_to_die_delay: common.types.base_types_pb2.Time | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['copper_clearance_override', b'copper_clearance_override', 'id', b'id', 'net', b'net', 'pad_stack', b'pad_stack', 'pad_to_die_delay', b'pad_to_die_delay', 'pad_to_die_length', b'pad_to_die_length', 'position', b'position']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['copper_clearance_override', b'copper_clearance_override', 'id', b'id', 'locked', b'locked', 'net', b'net', 'number', b'number', 'pad_stack', b'pad_stack', 'pad_to_die_delay', b'pad_to_die_delay', 'pad_to_die_length', b'pad_to_die_length', 'position', b'position', 'type', b'type']) -> None:
        ...
global___Pad = Pad
